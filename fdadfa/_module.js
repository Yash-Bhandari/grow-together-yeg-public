...
function create_fragment(ctx) {
	...
	return {
		...
		l(nodes) {
			const head_nodes = head_selector('svelte-1o0hhll', document.head);
...
class Component$1 extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$1, create_fragment$1, safe_not_equal, { favicon: 1, headline: 0 });
	}
}
...
class Component$3 extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$3, create_fragment$3, safe_not_equal, { favicon: 3, logo: 0, site_nav: 1 });
	}
}
...
function create_fragment$4(ctx) {
	...
	return {
		...
		h() {
			attr(div0, "class", "section-container content svelte-1vhxt2j");
			attr(div1, "class", "section");
			attr(div2, "class", "section");
			attr(div2, "id", "section-3c668f80");
		},
		m(target, anchor) {
			insert_hydration(target, div2, anchor);
...
function create_each_block$1(key_1, ctx) {
	...
	let if_block = /*activeItem*/ ctx[2] === /*i*/ ctx[8] && create_if_block$2(ctx);
...
function instance$5($$self, $$props, $$invalidate) {
	...
	return [heading, items, activeItem, setActiveItem, favicon, click_handler];
}

class Component$5 extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$5, create_fragment$5, safe_not_equal, { favicon: 4, heading: 0, items: 1 });
	}
}
...
function create_fragment$7(ctx) {
	...
	component_3 = new Component$4({
			props: {
				...
				content: {
					"html": "<h3 id=\"edmontoncantafforditsinfrastructureandbuildingnewneighbourhoodsmakestheproblemworse\">Edmonton can't afford its infrastructure — and building new neighbourhoods makes the problem worse</h3>\n<p>The city has an infrastructure maintenance deficit of <strong>$470 million per year</strong>. That's more than our entire public transit budget ($385 million) and almost as much as we spend on police ($495 million)! To make up for that deficit, we would have to <strong>raise property taxes by 28%</strong>. And since we can't afford to do critical preventative maintenance, that number will only grow with time.</p>\n<p>Why can't we afford to maintain the roads, bridges and sewage systems we already have? Because for decades we've been growing in an unsustainable way. Urban sprawl has wrought havoc on our balance sheets because the city loses money on every new neighborhood that gets built on the outskirts. For example, the new neighbourhood of Decoteau will add hundreds of millions of dollars to our budget shortfall.</p>\n<p><img src=\"https://dpfecbhwrshlsbfgbgzq.supabase.co/storage/v1/object/public/images/2c45c57d-3334-49f6-bc6a-7fecf6135bc0/1689308724419Decoteau%20Revenue.png\" alt=\"Revenue vs Expenditures for a typical new neighbourhood\" /></p>\n<h3 id=\"thesolutionbuildupourexistingneighbourhoods\">The solution: Build up our existing neighbourhoods</h3>\n<p>The new zoning bylaw will make it easier to build new middle-density homes in mature communities. That makes financial sense for a few reasons:  </p>\n<ol>\n<li>We don't have to build new roads or utilities from scratch. Old neighbourhoods often lose money like new ones, but we have already paid for the infrastructure.</li>\n<li>Denser housing forms like row houses and small apartments are much cheaper for the city to maintain than the detached homes they replace.</li>\n</ol>",
					"markdown": "### Edmonton can't afford its infrastructure — and building new neighbourhoods makes the problem worse \n\nThe city has an infrastructure maintenance deficit of **$470 million per year**. That's more than our entire public transit budget ($385 million) and almost as much as we spend on police ($495 million)! To make up for that deficit, we would have to **raise property taxes by 28%**. And since we can't afford to do critical preventative maintenance, that number will only grow with time.\n\nWhy can't we afford to maintain the roads, bridges and sewage systems we already have? Because for decades we've been growing in an unsustainable way. Urban sprawl has wrought havoc on our balance sheets because the city loses money on every new neighborhood that gets built on the outskirts. For example, the new neighbourhood of Decoteau will add hundreds of millions of dollars to our budget shortfall.\n\n![Revenue vs Expenditures for a typical new neighbourhood](https://dpfecbhwrshlsbfgbgzq.supabase.co/storage/v1/object/public/images/2c45c57d-3334-49f6-bc6a-7fecf6135bc0/1689308724419Decoteau%20Revenue.png)\n\n### The solution: Build up our existing neighbourhoods\n\nThe new zoning bylaw will make it easier to build new middle-density homes in mature communities. That makes financial sense for a few reasons:  \n1. We don't have to build new roads or utilities from scratch. Old neighbourhoods often lose money like new ones, but we have already paid for the infrastructure.\n2. Denser housing forms like row houses and small apartments are much cheaper for the city to maintain than the detached homes they replace.\n\n"
				}
			}
		});
